...
void __init msm8x25_kgsl_3d0_init(void)
{
	if (cpu_is_msm8625()) {
		...
		kgsl_3d0_pdata.strtstp_sleepwake = false;
			...
			kgsl_3d0_pdata.pwrlevel[1].gpu_freq = 350000000;
			kgsl_3d0_pdata.pwrlevel[1].bus_freq = 200000000;
		
			kgsl_3d0_pdata.pwrlevel[2].gpu_freq = 320000000;
			kgsl_3d0_pdata.pwrlevel[2].bus_freq = 200000000;

			kgsl_3d0_pdata.pwrlevel[3].gpu_freq = 300000000;
			kgsl_3d0_pdata.pwrlevel[3].bus_freq = 200000000;

			kgsl_3d0_pdata.pwrlevel[4].gpu_freq = 245760000;
			kgsl_3d0_pdata.pwrlevel[4].bus_freq = 200000000;
